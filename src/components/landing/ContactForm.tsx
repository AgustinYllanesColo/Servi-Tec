...
export const ContactForm = () => {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    const msg = `Hola SERVITEC, soy ${form.nombre} de ${form.zona}. Mi problema: ${form.problema}`;
  ...
  return (
    <section id="contacto" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-card border border-border rounded-3xl p-7 md:p-10 shadow-elegant reveal">
          ...
          <form onSubmit={submit} className="mt-8 grid gap-4">
            ...
            <button
              type="submit"
              className="mt-2 inline-flex items-center justify-center gap-2 h-14 px-7 rounded-full bg-whatsapp text-whatsapp-foreground font-bold shadow-cta hover:scale-[1.02] active:scale-95 transition-transform"
            >
